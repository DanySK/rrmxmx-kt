...
internal class Test {
    @Test
    fun `all tests of the original author should pass`() {
        ...
        mapOf(
            ...
            assertEquals(expected, Rrmxmx.rrmxmx(base))
            assertEquals(expected, Rrmxmx.rrmxmx(base.toLong()))
            assertEquals(expected.toLong(), Rrmxmx.hash(base))
            assertEquals(expected.toLong(), Rrmxmx.hash(base.toLong()))
        }
    }
}
